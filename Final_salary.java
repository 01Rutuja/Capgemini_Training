            ...
            if(b_pay>4500 && b_pay<6500){
               ...
               if(salary>10000){
                System.out.println("Eligible for Tax deduction of Rs.1000");
                   ...
                   System.out.println("Not eligible for Tax deduction of Rs.1000 due to salary less than 10000"); 
                }
            }
            else{
...
public class Final_salary {
   ...
   public static void main(String args[]) throws ParseException {
      ...
      if(period.getYears()<18){
            System.out.println("It is a not valid age for employee"); 
        }  
        else{
